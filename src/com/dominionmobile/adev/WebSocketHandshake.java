...
public class WebSocketHandshake
{
	...
	{
		//System.out.println("WebSocketHandshake() constructor");
	...
	{
		//System.out.println("WebSocketHandshake() getHandshake()");
	...
	{
		//System.out.println("WebSocketHandshake() generateHeader()");
	...
	{
		//System.out.println("WebSocketHandshake() createNonce()");
	...
	{
		//System.out.println("WebSocketHandshake() verifyServerStatusLine()");
	...
	public void verifyServerHandshakeHeaders(HashMap<String, String> headers)
			throws WebSocketException
	{
		//System.out.println("WebSocketHandshake() verifyServerHandshakeHeaders()");
		// Note:
		// This seemed to stop the Exception!
...
/**/		
    if (!((String)headers.get("upgrade")).equalsIgnoreCase("websocket")) {
      throw new WebSocketException("connection failed: missing header field in server handshake: upgrade");
    }
    if (!((String)headers.get("connection")).equalsIgnoreCase("upgrade"))
      throw new WebSocketException("connection failed: missing header field in server handshake: connection");
